...
import RuleSetSelector from './components/RuleSetSelector.vue'
import { useGameSettings } from './composables/useGameSettings'
import { useGameBoard } from './composables/useGameBoard'
import { useGameEngine } from './composables/useGameEngine'
import type { Pattern, Coordinate, RuleSet } from './core'
...
<template>
  <div class="app">
    ...
    <div class="app-content">
      <aside class="sidebar">
        <RuleSetSelector
          @change-ruleset="handleRuleSetChange"
        />
